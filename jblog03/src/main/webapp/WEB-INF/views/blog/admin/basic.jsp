	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="content" class="full-screen">
				...
				<form method="POST"  action="${pageContext.request.contextPath }/blog/${blogVo.id }/admin/basic" enctype="multipart/form-data">
	 		      	<table class="admin-config">
			      		<tr>
			      			<td class="t">블로그 제목</td>
			      			<td><input type="text" size="40" name="title" placeholder="${blogVo.title }"></td>
			      		</tr>
			      		<tr>
			      			<td class="t">로고이미지</td>
